...
/**
 * Return the duration between two dates or times.
 *
 * @param   {String|Moment} a    a date or time parseable by moment.js
 * @param   {String|Moment} b    another date or time parseable by moment.js
 * @returns {Duration}           the duration between a and b
 */
function duration(a, b) {
  let da = moment(a)
  let db = moment(b)
  return moment.duration(da.diff(db))
}
